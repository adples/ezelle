...
<nav class="hidden lg:block bg-neutral lg:py-2 xl:py-6 w-full" aria-label="navigation">
	...
	<div x-data="{ open: false }" class="flex lg:flex-row flex-col mx-auto px-6 container">
		...
		<ul id="primary-menu" :class="{'flex': open, 'hidden': !open}" class="hidden lg:flex lg:flex-row flex-col flex-grow items-center lg:space-x-12 xl:space-x-16 mb-0 lg:ml-15 2xl:ml-26 xl:ml-20">
